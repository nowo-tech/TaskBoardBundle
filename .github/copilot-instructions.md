...
- Task boards, teams, kanban columns, and task lifecycle for Symfony applications.
- Optional integration with TimeTrackBundle when present; keep coupling optional and documented.
